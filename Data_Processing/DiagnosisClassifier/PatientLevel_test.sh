...
export script='/cluster/tufts/hugheslab/zhuang12/JACC_CodeRelease/Echo_TMEDV2/Data_Processing/DiagnosisClassifier/PatientLevel_data_processing.py'
export split='test'
...
do
    ...
    export result_save_dir="/cluster/tufts/hugheslab/zhuang12/JACC_CodeRelease/Echo_TMEDV2/ML_DATA/DiagnosisClassifier/fold$seed/$version" 
