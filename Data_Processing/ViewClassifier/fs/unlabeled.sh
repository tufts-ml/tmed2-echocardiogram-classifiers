...
export script='/cluster/tufts/hugheslab/zhuang12/JACC_CodeRelease/Echo_TMEDV2/Data_Processing/ViewClassifier/fs/unlabeledset_data_processing.py'
export result_save_dir="/cluster/tufts/hugheslab/zhuang12/JACC_CodeRelease/Echo_TMEDV2/ML_DATA/ViewClassifier/fs" 
