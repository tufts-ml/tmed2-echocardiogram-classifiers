...
export nimg_per_epoch=1180
export report_nimg=7048
export save_nimg=7048

export train_dir="$YOUR_PATH/experiments/DiagnosisClassifier/seed0/DEV56"
export report_type="EMA_BalancedAccuracy"

export train_labeled_files='DiagnosisClassifier/seed0/DEV56/train.tfrecord'
export valid_files='DiagnosisClassifier/seed0/DEV56/val.tfrecord'
...
export diagnosis_class_weights="0.523,0.404,0.073"
export view_class_weights="0.089,0.275,0.236,0.324,0.073"
