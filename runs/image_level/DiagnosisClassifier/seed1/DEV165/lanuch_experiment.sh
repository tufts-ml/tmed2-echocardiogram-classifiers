...
export nimg_per_epoch=3676
export report_nimg=10728
export save_nimg=10728

export train_dir="$YOUR_PATH/experiments/DiagnosisClassifier/seed1/DEV165"
export report_type="EMA_BalancedAccuracy"

export train_labeled_files='DiagnosisClassifier/seed1/DEV165/train.tfrecord'
export valid_files='DiagnosisClassifier/seed1/DEV165/val.tfrecord'
...
export diagnosis_class_weights="0.545,0.387,0.065"
export view_class_weights="0.106,0.307,0.218,0.291,0.079"
