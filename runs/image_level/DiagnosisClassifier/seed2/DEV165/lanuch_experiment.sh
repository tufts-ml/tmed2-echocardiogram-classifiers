...
export train_epoch=450
export nimg_per_epoch=3094
export report_nimg=12376
export save_nimg=12376

export train_dir="$YOUR_PATH/experiments/DiagnosisClassifier/seed2/DEV165"
export report_type="EMA_BalancedAccuracy"

export train_labeled_files='DiagnosisClassifier/seed2/DEV165/train.tfrecord'
export valid_files='DiagnosisClassifier/seed2/DEV165/val.tfrecord'
export test_files='DiagnosisClassifier/seed2/shared_test_this_seed/test.tfrecord'
export stanford_test_files='stanford_A4C.tfrecord'

export diagnosis_class_weights="0.516,0.413,0.072"
export view_class_weights="0.101,0.291,0.227,0.288,0.093"
