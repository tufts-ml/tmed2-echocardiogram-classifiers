...
export nimg_per_epoch=10363
export report_nimg=10363
export save_nimg=10363

export train_dir="$YOUR_PATH/experiments/DiagnosisClassifier/fold2/DEV479"
export report_type="EMA_BalancedAccuracy"

export train_labeled_files='DiagnosisClassifier/fold2/DEV479/train.tfrecord'
export valid_files='DiagnosisClassifier/fold2/DEV479/val.tfrecord'
export test_files='DiagnosisClassifier/fold2/DEV479/test.tfrecord'
export stanford_test_files='stanford_A4C.tfrecord'

export diagnosis_class_weights="0.526,0.408,0.067"
export view_class_weights="0.106,0.303,0.223,0.292,0.077"
