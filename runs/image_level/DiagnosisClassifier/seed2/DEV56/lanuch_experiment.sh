...
export train_epoch=1300
export nimg_per_epoch=995
export report_nimg=9950
export save_nimg=9950

export train_dir="$YOUR_PATH/experiments/DiagnosisClassifier/seed2/DEV56"
export report_type="EMA_BalancedAccuracy"

export train_labeled_files='DiagnosisClassifier/seed2/DEV56/train.tfrecord'
export valid_files='DiagnosisClassifier/seed2/DEV56/val.tfrecord'
...
export diagnosis_class_weights="0.536,0.392,0.072"
export view_class_weights="0.099,0.293,0.233,0.296,0.080"
