...
export train_PLAX_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_PLAX_image.npy"
export train_PLAX_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_PLAX_label.npy"
export train_PSAX_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_PSAX_image.npy"
export train_PSAX_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_PSAX_label.npy"
export train_A4C_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_A4C_image.npy"
export train_A4C_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_A4C_label.npy"
export train_A2C_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_A2C_image.npy"
export train_A2C_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_A2C_label.npy"
export train_UsefulUnlabeled_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_UsefulUnlabeled_image.npy"
export train_UsefulUnlabeled_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/train_UsefulUnlabeled_label.npy"

export val_image_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/val_image.npy"
export val_label_path="$YOUR_PATH/ML_DATA/ViewClassifier/fixmatch/npy_seed1/DEV165/val_label.npy"
...
export train_dir="$YOUR_PATH/experiments/ViewClassifier/fixmatch/seed1/DEV165"

mkdir -p $train_dir

export train_epoch=120
export nimg_per_epoch=6372
