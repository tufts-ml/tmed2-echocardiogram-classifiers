...
#             print('Inside ResNet class, passed in dropout_rate is {}'.format(dropout_rate), flush=True)
        ...
        with tf.variable_scope('classify', reuse=tf.AUTO_REUSE, custom_getter=getter):
            ...
            for scale in range(scales):
                ...
                print('filters: {}'.format(filters), flush=True)
                print('filters<<scale: {}'.format(filters<<scale), flush=True)
